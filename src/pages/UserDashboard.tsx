...
export default function UserDashboard() {
    ...
    //   const [timelineDueration , setTimelineDuration] = useState<TimelineFetchIn>("day")

    //   const {data : APiData , isLoading : loading , error : err} = useQuery({
    //     queryKey : ['Timeline'],
    ...
    const navItems = [
        { icon: FaHome, label: 'Dashboard', path: '/dashboard', file: 'Dashboard' },
                ...
                <div className="h-20 border-b border-[#1E2330] flex items-center justify-between px-12">
                    <div>
                        {selectedFile == 'Dashboard' ? <div>
                            ...
                            :
                            <div>
                                <p className="font-serif text-2xl" >{selectedFile}</p>
                            </div>
