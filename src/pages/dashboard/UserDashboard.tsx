        ...
        <div className="min-h-screen bg-[#06070A] flex">
            ...
            <aside className="w-64 bg-[#0D1117] border-r border-[#1E2330] flex flex-col">
                ...
                className="p-6 border-t border-[#1E2330] flex items-center gap-3 hover:cursor-pointer">
                    <div className="w-10 h-10 rounded-full bg-linear-to-br from-[#B8F5D4] to-[#D4BCFF] " />
                    <div>
                        <div className="font-mono text-sm text-[#F0F2F5]">Krishna</div>
                        <div className="font-mono text-xs text-[#454C5E]">@krishna_dev</div>
                    </div>
                </div>
            </aside>
            ...
            <main className="flex-1 overflow-auto">
                ...
                <div className="h-20 border-b border-[#1E2330] flex items-center justify-between px-12">
                    <div>
                        <div className="font-mono text-xs text-[#454C5E] mb-1">Good morning,</div>
                        <div className="font-display text-2xl text-[#F0F2F5]">Krishna</div>
                    </div>
